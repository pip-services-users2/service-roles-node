...
import { RolesCommandableHttpServiceV1 } from '../services/version1/RolesCommandableHttpServiceV1';
...
export class RolesServiceFactory extends Factory {
	...
	public static CommandableHttpServiceDescriptor = new Descriptor("service-roles", "service", "commandable-http", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(RolesServiceFactory.CommandableHttpServiceDescriptor, RolesCommandableHttpServiceV1);
