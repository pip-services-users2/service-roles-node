# Deployment Guide <br/> Roles Microservice
...
var plugin = require('service-roles-node').RolesSenecaPlugin;
...
or by using [RolesSenecaClient](https://github.com/pip-services-users2/client-roles-node/NodeClientApiV1.md/#client_seneca)